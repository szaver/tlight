...
},{"./transport":18,"./transports":19,"component-emitter":11,"debug":13,"engine.io-parser":25,"indexof":31,"parsejson":37,"parseqs":38,"parseuri":39}],18:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":18,"component-inherit":12,"debug":13,"engine.io-parser":25,"parseqs":38,"xmlhttprequest-ssl":24,"yeast":54}],23:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":18,"component-inherit":12,"debug":13,"engine.io-parser":25,"parseqs":38,"ws":8,"yeast":54}],24:[function(require,module,exports){
...
},{"./keys":26,"after":2,"arraybuffer.slice":3,"base64-arraybuffer":6,"blob":7,"has-binary":27,"wtf-8":53}],26:[function(require,module,exports){
...
},{"./selector":36}],36:[function(require,module,exports){
...
},{"./to-inline-style":41,"classnames":9,"hyperscript-helpers":30,"parse-hyperscript":35,"preact":42}],41:[function(require,module,exports){
...
},{"@f/hyphenate":1}],42:[function(require,module,exports){
...
},{"./manager":44,"./socket":46,"./url":47,"debug":13,"socket.io-parser":50}],44:[function(require,module,exports){
...
},{"./on":45,"./socket":46,"backo2":5,"component-bind":10,"component-emitter":48,"debug":13,"engine.io-client":15,"indexof":31,"socket.io-parser":50}],45:[function(require,module,exports){
...
},{"./on":45,"component-bind":10,"component-emitter":48,"debug":13,"has-binary":28,"socket.io-parser":50,"to-array":52}],47:[function(require,module,exports){
(function (global){
...
},{"debug":13,"parseuri":39}],48:[function(require,module,exports){
...
},{"./binary":49,"./is-buffer":51,"component-emitter":11,"debug":13,"isarray":32,"json3":33}],51:[function(require,module,exports){
(function (global){
...
var ref = require('preact-hyperscript');
var div = ref.div;
var ref$1 = require('preact');
...
var socket = io()
var cameraId = Number(document.location.hash.substr(1))
...
var App = (function (Component) {
  ...
  App.prototype.componentDidMount = function componentDidMount () {
    ...
    socket.on('update', function (cameraState) {
      this$1.setState({cameraState: cameraState})
    })
    socket.on('chat message', function (msg) { return this$1.addMessage(msg); })
  };
  App.prototype.addMessage = function addMessage (message) {
    this.setState({messages: this.state.messages.concat( [message])})
  };
  App.prototype.localMessage = function localMessage (msg) {
    var message = {sender: cameraId, content: msg}
...
},{"./Chat":56,"./Header":57,"auto-bind":4,"preact":42,"preact-hyperscript":40,"socket.io-client":43}],56:[function(require,module,exports){
var ref = require('preact-hyperscript');
var div = ref.div;
var createComponent = ref.createComponent;

var Messages = require('./Messages')
var TypeBox = require('./TypeBox')

var Chat = function (ref) {
  var messages = ref.messages;
  var onMessage = ref.onMessage;

  return div('.chat', [
    Messages({messages: messages}),
    TypeBox({onMessage: onMessage})
  ])
}

module.exports = createComponent(Chat)

},{"./Messages":58,"./TypeBox":59,"preact-hyperscript":40}],57:[function(require,module,exports){
var ref = require('preact-hyperscript');
var div = ref.div;
var createComponent = ref.createComponent;
...
},{"preact-hyperscript":40}],58:[function(require,module,exports){
var ref = require('preact-hyperscript');
var div = ref.div;
var createComponent = ref.createComponent;

var Messages = function (ref) {
  var messages = ref.messages;

  return div('.msgs', [
    div('.msgs__inner', messages.map(function (msg) {
...
},{"preact-hyperscript":40}],59:[function(require,module,exports){
var ref = require('preact-hyperscript');
var textarea = ref.textarea;
var createComponent = ref.createComponent;

var TypeBox = function (ref) {
  var onMessage = ref.onMessage;
...
},{"preact-hyperscript":40}],60:[function(require,module,exports){
var ref = require('preact');
var render = ref.render;
var ref$1 = require('preact-hyperscript');
var createElement = ref$1.createElement;
...
},{"./App":55,"preact":42,"preact-hyperscript":40}]},{},[60]);
